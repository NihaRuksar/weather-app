...
root.resizable(False,False) #diasble resizing of window
def getWeather():
    city=textfield.get()
    ...
    #weather
    api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=2ca152f53a4369d8d9990cccf627d4ee"
...
root.mainloop() #keep the window open and responsive
